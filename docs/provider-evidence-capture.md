...
- USD stock orders use the USD wallet and still require a fresh approved `admin_manual` USD/KRW snapshot for audit consistency.
...
| `TWELVE_DATA_API_KEY` | unset | Twelve Data USD/KRW, US stock, and crypto live fixtures `BLOCKED` |
...
- Twelve Data crypto fixture: `BLOCKED`, credentials unavailable.
...
| `docs/provider-fixtures/twelvedata-crypto-sample.json` | Not created | `TWELVE_DATA_API_KEY` unavailable |
...
| `docs/provider-fixtures/twelvedata-crypto-sample.json` | Twelve Data | Crypto | No | n/a | `BLOCKED` | n/a; file absent | n/a | `TWELVE_DATA_API_KEY` unavailable |
...
| Twelve Data | `/exchange_rate?symbol=BTC/USD` | `asset_price_snapshots` | `twelve_data_exchange_rate` | `rate` candidate | `timestamp` candidate | Unix seconds -> UTC DateTime | Server receipt time | Not proven | `BLOCKED` |
| Twelve Data | `/quote?symbol=BTC/USD` | `asset_price_snapshots` | `twelve_data_quote` | `close` candidate | `last_quote_at` or `timestamp` candidate | Selected Unix seconds -> UTC DateTime | Server receipt time | Not proven | `BLOCKED` |
...
| `docs/provider-fixtures/twelvedata-crypto-sample.json` | n/a | n/a | n/a | n/a | n/a | File not created |
...
| Twelve Data crypto live fixture | BLOCKED | `TWELVE_DATA_API_KEY` unavailable; endpoint choice and exchange aggregation remain unverified |
